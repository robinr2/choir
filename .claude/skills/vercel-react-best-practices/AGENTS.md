...
Comprehensive performance optimization guide for React applications, designed for AI agents and LLMs. Contains 55 rules across 7 categories, prioritized by impact from critical (eliminating waterfalls, reducing bundle size) to incremental (advanced patterns). Each rule includes detailed explanations, real-world examples comparing incorrect vs. correct implementations, and specific impact metrics to guide automated refactoring and code generation.
...
2. [Bundle Size Optimization](#2-bundle-size-optimization) — **CRITICAL**
   ...
   - 2.3 [Prefer Statically Analyzable Paths](#23-prefer-statically-analyzable-paths)
   - 2.4 [Preload Based on User Intent](#24-preload-based-on-user-intent)
...
5. [Rendering Performance](#5-rendering-performance) — **MEDIUM**
   ...
   - 5.8 [Use React DOM Resource Hints](#58-use-react-dom-resource-hints)
...
> **TypeScript warning:** Some libraries (notably `lucide-react`) don't ship `.d.ts` files for their deep import paths. Importing from `lucide-react/dist/esm/icons/check` resolves to an implicit `any` type, causing errors under `strict` or `noImplicitAny`. Verify the library exports types for its subpaths before using direct imports.
...
Reference: [https://vite.dev/guide/features.html](https://vite.dev/guide/features.html), [https://esbuild.github.io/api/](https://esbuild.github.io/api/), [https://www.npmjs.com/package/@rollup/plugin-dynamic-import-vars](https://www.npmjs.com/package/@rollup/plugin-dynamic-import-vars), [https://webpack.js.org/guides/dependency-management/](https://webpack.js.org/guides/dependency-management/)
...
### 5.8 Use React DOM Resource Hints

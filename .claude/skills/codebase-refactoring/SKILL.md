...
```bash
npx --prefix server jscpd --health --reporters ai <path>
```
...
```bash
npx --prefix server jscpd --dead-code --reporters ai <path>
```
...
```bash
npx --prefix server jscpd --complexity --reporters ai --summary-top 10 <path>
# or, ranked alongside duplication and size:
npx --prefix server jscpd --reporters ai --summary --summary-by complexity <path>
```
